...
describe('StickerFeaturesList', () => {
  ...
  it('displays specific features with correct content', () => {
    ...
    expect(secondFeature.find('.sticker-page__features-description').text()).toContain(
    ...
    expect(apiFeature.find('.sticker-page__features-description').text()).toContain(
      'Fetches fresh cat images from external API'
    )
  })
