...
describe('StickerDemoInfo', () => {
  ...
  it('displays the correct demo information text', () => {
    ...
    expect(text.text()).toContain('Look for the animated sticker button on the right side of your screen');
    expect(text.text()).toContain('Hover over it to reveal adorable cat images fetched in real-time!');
